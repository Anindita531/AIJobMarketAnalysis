...
- 💼 How do AI job salaries vary by role, location, or experience?  
...
- Key columns: *job_title, company, location, salary, skills, date_posted*

---

## 📊 Findings & Insights

Include high-level insights here like:

- 🔹 **Top roles**: Machine Learning Engineer, AI Specialist, Data Scientist  
- 💰 **Salary patterns**: Remote jobs offer higher median salaries  
...
- Add **ML model** to predict future job trend growth  
- Use **real-time job scraping** for dynamic updates  
- Build a **web dashboard** with interactive filters
